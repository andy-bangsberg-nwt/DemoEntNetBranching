namespace DemoEntNetBranching.Models
{
    public static class StudentDB
    {
        static List<Student> listStudent = new List<Student>()
        {
            ...
            new Student("Gabe", "Skramstad"),
            new Student("Steven", "Nunley"),
            new Student("Chris", "Bjerklien"),
            new Student("Lucian", "Brande"),
            new Student("Rogerife", "Samuels"),
            ...
            new Student("Nash", "Czerwonka"), 
            new Student("Taylor", "Krajnak")
          };
